...
<main class="add-clothing w-25 m-auto">
    <form action="/user-management" method="post" class="row">
        ...
        <div class="form-group col-12">
            ...
            <c:if test="${tempUser != null}">
                <input type="password" name="password" id="password" class="form-control form-control-sm" value="${tempUser.password}" required>
            </c:if>
            <c:if test="${tempUser == null}">
        ...
        <button type="submit" value="Add User" class="mt-3 btn-blue col-2">Add</button>
    </form>
</main>
